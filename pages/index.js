...
import { maxCharAllowedOnPostComment, maxImageSizeAllowed_Feed, showAdsAfter_Feed } from "../utils/provider";
...
export default function Home(props) {
  ...
  const getConfessions = (append = false, page = 1, act = "all") => {
    getConfessionsService({ act: act === 0 ? "all" : act, page, dispatch, append })
  }
  ...
  const fetchMoreData = () => {
    if (confessionRed?.page)
      getConfessions(true, confessionRed?.page + 1)
  }
  ...
  if (confessions.length === 0 && confessionRed.status === apiStatus.FULFILLED)
    return <h5 className='endListMessage noConfessions mx-auto'>No Confessions found in this category</h5>
      ...
      <div className="postCont hideBoxShadow">
        <div className="doCommentContHeader container-fluid">
          ...
          <div className="confessImgContInCaptha">
            <Image src="/images/confessionBanner.png" alt="confessionBanner" fill={true} />
          </div>
        </div>
            ...
            <div className="selectNpostBtnCont">
                  ...
                  <div className={`cstmUploadFileCont feedPage ${base64Src.length > 0 ? "feedMb15" : ""}`}>
                    <div className="uploadImgFeedCont">
                      <label htmlFor="uploadImages" className="uploadImgWrapper">
                        <Image src="/images/uploadImages.svg" alt="uploadImages" className='mr-0' width={20} height={20} />
                      </label>
                      <input
                        type="file"
                        ...
                        <div className="imgContForPreviewImg feed">
                          {base64Src.map((elem, index) => {
                            return (<span className="uploadeImgWrapper feed" key={"imgPreviewCont9" + index} value={index} onClick={() => { removeImg(index) }}>
                              <Image src={elem.toString()} alt="" className='previewImg' fill={true} />
                              <Image src="/images/removeImgIcon.png" alt="removeImgIcon" className='removeImgIcon' type="button" width={20} height={20} />
                            </span>)
                          })}
              ...
              <div className="feedSPbtnsWrapper">
                ...
                <div className="form-group createPostInputs createInputSelect mb-0">
                  ...
                  <Image src="/images/downArrow.png" alt="downArrow" type="button" onClick={openSelect} width={5} height={23} />
